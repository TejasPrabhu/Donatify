...
| If the software can be used as a library, package or service by other software, do the team provide comprehensive API documentation? | 3 | Yes, [Backend](https://htmlpreview.github.io/?https://github.com/TejasPrabhu/Donatify/blob/main/docs/Backend/index.html) API documentation exists
| Did the team store the documentation under revision control with your source code? | 3 | Yes, both frontend and backend documentation stored in the [frontendDocs](https://htmlpreview.github.io/?https://github.com/TejasPrabhu/Donatify/blob/main/docs/frontendDocs/left-overs/0.1.0/index.html) and [backendDocs](https://github.com/TejasPrabhu/Donatify/tree/main/docs/Backend) Github branches respectively |
